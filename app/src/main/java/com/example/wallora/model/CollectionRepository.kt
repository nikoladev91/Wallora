...
object CollectionRepository {
    ...
    val collections = listOf(
        WallpaperCollection(
            ...
            coverImage = RainbowChaosCollection.wallpapers.first().image,
            wallpapers = RainbowChaosCollection.wallpapers,
            isPremium = false
        ),
        WallpaperCollection(
            id = "rainy_nights_vol_1",
            title = "Rainy Nights",
            subtitle = "Atmospheric Rainy Night Wallpapers",
            coverImage = RainyNightsCollection.wallpapers.first().image,
            wallpapers = RainyNightsCollection.wallpapers,
            isPremium = false
        ),
        ...
        WallpaperCollection(
            ...
            title = "Mystic Cats",
            subtitle = "12 Mystical and Magical Cat Wallpapers",
            coverImage = MysticCatsCollection.wallpapers.first().image,
            wallpapers = MysticCatsCollection.wallpapers,
            isPremium = false
        ),
        WallpaperCollection(
